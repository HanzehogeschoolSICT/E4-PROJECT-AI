...
public class ReversiPosPriority {
    ...
    private static final int highestPriorityValue = 2;
    private static final int highPriorityValue = 1;
    private static final int normalPriorityValue = 0;
    private static final int lowPriorityValue = -1;
    private static final int lowestPriorityValue = -2;
